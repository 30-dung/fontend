...
export function ResetPasswordPage() {
  ...
  const validateForm = () => {
    let valid = true;
    const newErrors: FormErrors = { otp: "", password: "", confirmPassword: "" };
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
          ...
          <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="otp" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">OTP Code</label>
              <input
                type="text"
                name="otp"
                id="otp"
              ...
              />
              {formErrors.otp && (
                <p className="text-sm text-red-500">{formErrors.otp}</p>
              )}
            </div>
            <div>
