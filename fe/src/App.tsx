...
import { Booking } from './components/pages/client/booking/BookingForm';
...
import { SelectStylistAndTime } from './components/pages/client/booking/SelectStylistAndTime';
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/stylist-and-time" element={<Layout><SelectStylistAndTime /></Layout>} />
